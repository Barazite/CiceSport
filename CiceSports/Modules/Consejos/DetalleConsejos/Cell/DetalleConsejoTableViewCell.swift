//
//  DetalleConsejoTableViewCell.swift
//  CiceSports
//
...
class DetalleConsejoTableViewCell: UITableViewCell, DetalleConsejoCellProtocol {
    
    static let identifier = String(describing: DetalleConsejoTableViewCell.self)
